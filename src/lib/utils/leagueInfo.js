/*   STEP 1   */
export const leagueID = "784654068411998208"; // your league ID
export const leagueName = "DynasTANGY Redraft Edition: Not a Dynasty League"; // your league name
...
export const managers = [
    {
      ...
      "bio": "Born on February 24th 1992, a future perineal 2nd place team manager was born",
      "photo": "/managers/Matt3.jpg", // square ratio recommended (no larger than 500x500)
      ...
      "rival": {
        ...
        image: "/managers/James.png", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
      ...
      "philosophy": "2nd place counts for something",
    ...
    },
  {
      ...
      "name": "John Charles Thiel Amoa III",
    ...
    },
    {
      ...
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Whiteknight", // Can be anything (usually your rival's name)
